...
This is not really a project, but rather a topic I want to focus on more in my research. I am only just starting this new focus, so there is not yet much I can show, but below I explain why I want to focus on this more and some steps I've taken so far.
...
I've started my own project that is a meta-analysis on meat intervention studies. There have been several meta-analyses on this topic (see [here](https://www.sciencedirect.com/science/article/pii/S0195666321001847) for a recent one), but I think I can contribute in some unique ways by creating a 'live meta-analysis' that can continuously be updated with new studies.
...
Finally, I will join the Animal Advocacy Conference that will be held later this month (June 30th to July 2nd, 2021). See [here](https://blogs.kent.ac.uk/animaladvocacy/) for more information on this conference.
